...
import { analyzeProductImage, generateProductDescription, categorizeProduct } from '../services/aiService.js';
...
router.post('/generate-description', 
  ...
  asyncHandler(async (req: any, res: any) => {
    ...
    try {
      const description = await generateProductDescription(productName, tags || []);
